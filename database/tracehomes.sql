...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3219756326ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="179">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tracehomes&table=contacts">`tracehomes`.`contacts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tracehomes&table=user">`tracehomes`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tracehomes&table=orders">`tracehomes`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emma&table=user">`emma`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="456326592452355d6f653f562c412346">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="179"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="emma" targettable="user">
            ...
            Queried time
                            ...
                            <span class="query">CREATE USER &#039;ARTKINS&#039;@&#039;%&#039; IDENTIFIED VIA mysql_native_password USING &#039;***&#039;;GRANT ALL PRIVILEGES ON *.* TO &#039;ARTKINS&#039;@&#039;%&#039; REQUIRE NONE WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `ARTKINS\_%`.* TO &#039;ARTKINS&#039;@&#039;%&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="tracehomes" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tracehomes" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tracehomes" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user` DROP `admin`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tracehomes" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="homeverse" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE contacts (
    mobile VARCHAR(20),
    email VARCHAR(255),
    address VARCHAR(255),
    registration DATE
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tracehomes" targettable="contacts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
